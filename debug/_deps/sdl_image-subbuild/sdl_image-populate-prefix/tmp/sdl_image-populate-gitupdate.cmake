...
function(get_hash_for_ref ref out_var err_var)
  execute_process(
    COMMAND "C:/Program Files/Git for Windows/cmd/git.exe" --git-dir=.git rev-parse "${ref}^0"
...
execute_process(
  COMMAND "C:/Program Files/Git for Windows/cmd/git.exe" --git-dir=.git show-ref "release-2.6.2"
  WORKING_DIRECTORY "C:/Users/samuel.barnett/Documents/repos/Mobagen/debug/_deps/sdl_image-src"
...
if(show_ref_output MATCHES "^[a-z0-9]+[ \\t]+refs/remotes/")
  ...
  set(checkout_name "release-2.6.2")
...
elseif(show_ref_output MATCHES "^[a-z0-9]+[ \\t]+refs/tags/")
  ...
  get_hash_for_ref("release-2.6.2" tag_sha error_msg)
...
elseif(show_ref_output MATCHES "^[a-z0-9]+[ \\t]+refs/heads/")
  ...
  set(fetch_required YES)
  set(checkout_name "origin/release-2.6.2")
...
if(fetch_required)
  ...
  execute_process(
    COMMAND "C:/Program Files/Git for Windows/cmd/git.exe" --git-dir=.git fetch --tags --force "origin"
    WORKING_DIRECTORY "C:/Users/samuel.barnett/Documents/repos/Mobagen/debug/_deps/sdl_image-src"
...
if(git_update_strategy MATCHES "^REBASE(_CHECKOUT)?$")
  ...
  execute_process(
    COMMAND "C:/Program Files/Git for Windows/cmd/git.exe" --git-dir=.git symbolic-ref -q HEAD
    WORKING_DIRECTORY "C:/Users/samuel.barnett/Documents/repos/Mobagen/debug/_deps/sdl_image-src"
  ...
  if(current_branch STREQUAL "")
    ...
    execute_process(
      COMMAND "C:/Program Files/Git for Windows/cmd/git.exe" --git-dir=.git for-each-ref "--format=%(upstream:short)" "${current_branch}"
      WORKING_DIRECTORY "C:/Users/samuel.barnett/Documents/repos/Mobagen/debug/_deps/sdl_image-src"
...
execute_process(
  COMMAND "C:/Program Files/Git for Windows/cmd/git.exe" --git-dir=.git status --porcelain
  WORKING_DIRECTORY "C:/Users/samuel.barnett/Documents/repos/Mobagen/debug/_deps/sdl_image-src"
  RESULT_VARIABLE error_code
...
if(need_stash)
  execute_process(
    COMMAND "C:/Program Files/Git for Windows/cmd/git.exe" --git-dir=.git stash save --quiet;--include-untracked
    WORKING_DIRECTORY "C:/Users/samuel.barnett/Documents/repos/Mobagen/debug/_deps/sdl_image-src"
    COMMAND_ERROR_IS_FATAL ANY
  )
endif()
...
if(git_update_strategy STREQUAL "CHECKOUT")
  execute_process(
    COMMAND "C:/Program Files/Git for Windows/cmd/git.exe" --git-dir=.git checkout "${checkout_name}"
    WORKING_DIRECTORY "C:/Users/samuel.barnett/Documents/repos/Mobagen/debug/_deps/sdl_image-src"
    COMMAND_ERROR_IS_FATAL ANY
  )
else()
  execute_process(
    COMMAND "C:/Program Files/Git for Windows/cmd/git.exe" --git-dir=.git rebase "${checkout_name}"
    WORKING_DIRECTORY "C:/Users/samuel.barnett/Documents/repos/Mobagen/debug/_deps/sdl_image-src"
    RESULT_VARIABLE error_code
  ...
  if(error_code)
    ...
    execute_process(
      COMMAND "C:/Program Files/Git for Windows/cmd/git.exe" --git-dir=.git rebase --abort
      WORKING_DIRECTORY "C:/Users/samuel.barnett/Documents/repos/Mobagen/debug/_deps/sdl_image-src"
    )
    ...
    if(NOT git_update_strategy STREQUAL "REBASE_CHECKOUT")
      ...
      if(need_stash)
        execute_process(
          COMMAND "C:/Program Files/Git for Windows/cmd/git.exe" --git-dir=.git stash pop --index --quiet
          WORKING_DIRECTORY "C:/Users/samuel.barnett/Documents/repos/Mobagen/debug/_deps/sdl_image-src"
          )
      endif()
      message(FATAL_ERROR "\nFailed to rebase in: 'C:/Users/samuel.barnett/Documents/repos/Mobagen/debug/_deps/sdl_image-src'."
    ...
    execute_process(
      COMMAND "C:/Program Files/Git for Windows/cmd/git.exe" --git-dir=.git tag -a
...
if(need_stash)
  ...
  if(error_code)
    ...
    execute_process(
      COMMAND "C:/Program Files/Git for Windows/cmd/git.exe" --git-dir=.git reset --hard --quiet
      WORKING_DIRECTORY "C:/Users/samuel.barnett/Documents/repos/Mobagen/debug/_deps/sdl_image-src"
    )
    execute_process(
      COMMAND "C:/Program Files/Git for Windows/cmd/git.exe" --git-dir=.git stash pop --quiet
      WORKING_DIRECTORY "C:/Users/samuel.barnett/Documents/repos/Mobagen/debug/_deps/sdl_image-src"
      RESULT_VARIABLE error_code
    )
    if(error_code)
      ...
      execute_process(
        COMMAND "C:/Program Files/Git for Windows/cmd/git.exe" --git-dir=.git reset --hard --quiet ${head_sha}
        WORKING_DIRECTORY "C:/Users/samuel.barnett/Documents/repos/Mobagen/debug/_deps/sdl_image-src"
      )
      execute_process(
        COMMAND "C:/Program Files/Git for Windows/cmd/git.exe" --git-dir=.git stash pop --index --quiet
      ...
      message(FATAL_ERROR "\nFailed to unstash changes in: 'C:/Users/samuel.barnett/Documents/repos/Mobagen/debug/_deps/sdl_image-src'."
                          "\nYou will have to resolve the conflicts manually")
    endif()
  endif()
endif()
...
if(init_submodules)
  execute_process(
    COMMAND "C:/Program Files/Git for Windows/cmd/git.exe" --git-dir=.git submodule update --recursive --init 
    WORKING_DIRECTORY "C:/Users/samuel.barnett/Documents/repos/Mobagen/debug/_deps/sdl_image-src"
    COMMAND_ERROR_IS_FATAL ANY
  )
endif()
