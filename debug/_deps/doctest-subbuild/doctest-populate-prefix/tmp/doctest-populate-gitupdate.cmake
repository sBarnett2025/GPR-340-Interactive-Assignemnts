...
function(get_hash_for_ref ref out_var err_var)
  execute_process(
    ...
    WORKING_DIRECTORY "C:/Users/samuel.barnett/Documents/repos/Mobagen/debug/_deps/doctest-src"
...
execute_process(
  COMMAND "C:/Program Files/Git for Windows/cmd/git.exe" --git-dir=.git show-ref "v2.4.8"
  WORKING_DIRECTORY "C:/Users/samuel.barnett/Documents/repos/Mobagen/debug/_deps/doctest-src"
...
if(git_update_strategy STREQUAL "CHECKOUT")
  ...
  if(error_code)
    ...
    if(NOT git_update_strategy STREQUAL "REBASE_CHECKOUT")
      ...
      message(FATAL_ERROR "\nFailed to rebase in: 'C:/Users/samuel.barnett/Documents/repos/Mobagen/debug/_deps/doctest-src'."
...
if(need_stash)
  ...
  if(error_code)
    ...
    if(error_code)
      ...
      message(FATAL_ERROR "\nFailed to unstash changes in: 'C:/Users/samuel.barnett/Documents/repos/Mobagen/debug/_deps/doctest-src'."
                          "\nYou will have to resolve the conflicts manually")
    endif()
  endif()
endif()
