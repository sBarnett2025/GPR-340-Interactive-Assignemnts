...
function(get_hash_for_ref ref out_var err_var)
  execute_process(
    ...
    WORKING_DIRECTORY "C:/Users/samuel.barnett/Documents/repos/Mobagen/debug/_deps/sdl2-src"
...
execute_process(
  COMMAND "C:/Program Files/Git for Windows/cmd/git.exe" --git-dir=.git show-ref "release-2.26.2"
  WORKING_DIRECTORY "C:/Users/samuel.barnett/Documents/repos/Mobagen/debug/_deps/sdl2-src"
...
if(show_ref_output MATCHES "^[a-z0-9]+[ \\t]+refs/remotes/")
  ...
  set(checkout_name "release-2.26.2")
...
elseif(show_ref_output MATCHES "^[a-z0-9]+[ \\t]+refs/tags/")
  ...
  get_hash_for_ref("release-2.26.2" tag_sha error_msg)
...
elseif(show_ref_output MATCHES "^[a-z0-9]+[ \\t]+refs/heads/")
  ...
  set(fetch_required YES)
  set(checkout_name "origin/release-2.26.2")
...
if(git_update_strategy STREQUAL "CHECKOUT")
  ...
  if(error_code)
    ...
    if(NOT git_update_strategy STREQUAL "REBASE_CHECKOUT")
      ...
      message(FATAL_ERROR "\nFailed to rebase in: 'C:/Users/samuel.barnett/Documents/repos/Mobagen/debug/_deps/sdl2-src'."
...
if(need_stash)
  ...
  if(error_code)
    ...
    if(error_code)
      ...
      message(FATAL_ERROR "\nFailed to unstash changes in: 'C:/Users/samuel.barnett/Documents/repos/Mobagen/debug/_deps/sdl2-src'."
                          "\nYou will have to resolve the conflicts manually")
    endif()
  endif()
endif()
